 ...
 */
let state = "New York"
let nyCapital = stateCapitals["New York"]
...
var bandMembers = [
    "Nirvana" : ["Kurt Cobain", "Krist Novoselic", "Dave Grohl"],
    "The Beatles" : ["John Lennon", "George Harrison", "Paul McCartney", "Ringo Starr"],
    "The Breeders" : ["Kim Deal", "Kelley Deal", "Josephine Wiggs", "Jim Macphearson"],
    "Pixies" : ["Frank Black", "Joey Santiago", "Kim Deal", "David Lovering"],
]
/*: question12
 ...
 */
let bandName = "Pixies"
var pixieMembers = bandMembers[bandName]

if let pixieMembers = pixieMembers {
    print(pixieMembers)
} else {
    print("There's no members in that band")
}
/*:
 [Solution](solution)
 */
